defmodule PaymentCompliancePlatform.Repo.Migrations.FixTriggerAncestorBalancePropagation do
  use Ecto.Migration

  def change do
    # Replace trigger function to also update ledger_accounts.balance for all ancestor accounts,
    # not just the directly targeted account.
    execute(
      """
