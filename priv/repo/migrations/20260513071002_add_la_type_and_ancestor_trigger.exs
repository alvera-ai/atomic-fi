defmodule AtomicFi.Repo.Migrations.AddLaTypeAndAncestorTrigger do
  ...
  BEGIN
    CASE NEW.la_type
      WHEN 'counter_party_root',
           'account_holder_payment_account_root' THEN
      ...
      WHEN 'account_holder_payment_account_regime_root' THEN
        ...
        NEW.ancestor_ids := ARRAY[ah_pa_root_id]::uuid[];
  ...
  def change do
    ...
    create constraint(:ledger_accounts, :la_type_shape_check, check: @la_type_shape_check)
    ...
    execute(@trigger_fn, "DROP FUNCTION IF EXISTS ledger_accounts_resolve_ancestor_ids()")
