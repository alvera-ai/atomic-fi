defmodule AtomicFi.OpenApiSchemaHelpers do
  @moduledoc """
  ...
  ## Example
      ...
      deflistresponse TenantListResponse, AtomicFi.OpenApiSchema.TenantResponse, "tenants"
  ...
  defmacro deflistresponse(name, item_schema, plural_name) do
    ...
    # Extract schema title from module name (e.g., AtomicFi.OpenApiSchema.TenantResponse -> TenantResponse)
  ...
  ## Example
      ...
      defdataresponse ServiceCategoriesDataResponse, AtomicFi.OpenApiSchema.ServiceCategoryResponse, "service categories"
  """
