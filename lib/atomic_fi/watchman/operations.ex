defmodule AtomicFi.Watchman.Operations do
  @moduledoc """
  ...
  **Content Types**: `text/plain`
  ...
  @spec v2_ingest_file_type_post(fileType :: String.t(), body :: String.t(), opts :: keyword) ::
          {:ok, AtomicFi.Watchman.IngestFileResponse.t()} | :error
  def v2_ingest_file_type_post(fileType, body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [fileType: fileType, body: body],
      call: {AtomicFi.Watchman.Operations, :v2_ingest_file_type_post},
      url: "/v2/ingest/#{fileType}",
      body: body,
      method: :post,
      request: [{"text/plain", :string}],
      response: [{200, {AtomicFi.Watchman.IngestFileResponse, :t}}],
      opts: opts
    })
  end
  ...
  @spec v2_listinfo_get(opts :: keyword) ::
          {:ok, AtomicFi.Watchman.ListInfoResponse.t()} | :error
  def v2_listinfo_get(opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [],
      call: {AtomicFi.Watchman.Operations, :v2_listinfo_get},
      url: "/v2/listinfo",
      method: :get,
      response: [{200, {AtomicFi.Watchman.ListInfoResponse, :t}}],
      opts: opts
    })
  end
  ...
  @spec v2_search_get(opts :: keyword) ::
          {:ok, AtomicFi.Watchman.SearchResponse.t()}
  ...
  def v2_search_get(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {AtomicFi.Watchman.Operations, :v2_search_get},
      url: "/v2/search",
      method: :get,
      query: query,
      response: [
        {200, {AtomicFi.Watchman.SearchResponse, :t}},
        {400, {AtomicFi.Watchman.ErrorResponse, :t}},
        default: :null
      ],
      opts: opts
    })
