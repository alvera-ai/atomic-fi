defmodule PaymentCompliancePlatform.OpenApiSchemaHelpers do
  @moduledoc """
  ...
  ## Example
      ...
      deflistresponse TenantListResponse, PaymentCompliancePlatform.OpenApiSchema.TenantResponse, "tenants"
  ...
  defmacro deflistresponse(name, item_schema, plural_name) do
    ...
    # Extract schema title from module name (e.g., PaymentCompliancePlatform.OpenApiSchema.TenantResponse -> TenantResponse)
  ...
  ## Example
      ...
      defdataresponse ServiceCategoriesDataResponse, PaymentCompliancePlatform.OpenApiSchema.ServiceCategoryResponse, "service categories"
  """
