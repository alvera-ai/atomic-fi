defmodule PaymentCompliancePlatform.Extensions.Ecto.Encrypted.Binary do
  @moduledoc """
  ...
  defmodule MySchema do
    ...
    schema "my_table" do
      field :sensitive_data, PaymentCompliancePlatform.Extensions.Ecto.Encrypted.Binary
      # ...
    end
  end
  ```
  ...
  - The encryption is handled by the PaymentCompliancePlatform.Vault configuration.

  For more information, see the [Cloak.Ecto documentation](https://hexdocs.pm/cloak_ecto).
  """
  use Cloak.Ecto.Binary, vault: PaymentCompliancePlatform.Vault
