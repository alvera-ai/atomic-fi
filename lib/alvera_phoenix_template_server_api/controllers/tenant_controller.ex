defmodule AlveraPhoenixTemplateServerApi.TenantController do
  ...
  alias AlveraPhoenixTemplateServer.OpenApiSchema.TenantListResponse
  alias AlveraPhoenixTemplateServer.OpenApiSchema.TenantRequest
  alias AlveraPhoenixTemplateServer.OpenApiSchema.TenantResponse
  alias AlveraPhoenixTemplateServer.RoleContext.RoleConstants
