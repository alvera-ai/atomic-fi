defmodule AlveraPhoenixTemplateServerApi.Helpers.ApiHelpers do
  @moduledoc """
  ...
  @openapi_spec OpenApiSpex.resolve_schema_modules(AlveraPhoenixTemplateServerApi.ApiSpec.spec())
