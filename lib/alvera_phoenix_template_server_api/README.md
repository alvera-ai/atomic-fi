# AlveraPhoenixTemplateServer API
...
```
lib/alvera_phoenix_template_server_api/
...
In your `lib/alvera_phoenix_template_server_web/router.ex`:

```elixir
defmodule AlveraPhoenixTemplateServerWeb.Router do
  use AlveraPhoenixTemplateServerWeb, :router
  use AlveraPhoenixTemplateServerApi.Routes  # Add this line
...
- `lib/alvera_phoenix_template_server/plugs/api_auth.ex`
...
OpenAPI schemas are automatically generated from your Ecto schemas when using `AlveraPhoenixTemplateServer.Schema`.
...
defmodule AlveraPhoenixTemplateServerApi.UserControllerTest do
  use AlveraPhoenixTemplateServerWeb.ConnCase
  ...
  test "lists users", %{conn: conn} do
    ...
    assert_schema(response, "UserListResponse", AlveraPhoenixTemplateServerApi.ApiSpec.spec())
  end
end
```
