defmodule AlveraPhoenixTemplateServerApi.Controller do
  @moduledoc """
  ...
  Replace `use AlveraPhoenixTemplateServerWeb, :controller` with:
  ...
  `AlveraPhoenixTemplateServerWeb.ErrorJSON`, which returns the standard error format:

      %{errors: %{detail: "Not Found"}}

  ## Example

      defmodule AlveraPhoenixTemplateServerApi.TenantController do
        use AlveraPhoenixTemplateServerApi.Controller
    ...
    quote do
      ...
      def action(conn, _params) do
        ...
        Ecto.NoResultsError ->
          ...
          |> Phoenix.Controller.put_view(json: AlveraPhoenixTemplateServerWeb.ErrorJSON)
