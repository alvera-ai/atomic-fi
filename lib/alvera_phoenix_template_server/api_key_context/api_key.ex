defmodule AlveraPhoenixTemplateServer.ApiKeyContext.ApiKey do
  use AlveraPhoenixTemplateServer.Schema

  alias AlveraPhoenixTemplateServer.Extensions.Ecto.Encrypted.Binary, as: EncryptedBinary
  ...
  * `updated_at` - Timestamp when API key was last updated
  ...
  typed_schema "api_keys" do
    ...
    belongs_to :role, AlveraPhoenixTemplateServer.RoleContext.Role
