defmodule AtomicFiApi.BlocklistEntryController do
  use AtomicFiApi.Controller
  use OpenApiSpex.ControllerSpecs

  alias AtomicFi.BlocklistContext
  alias AtomicFi.OpenApiSchema
  alias AtomicFi.OpenApiSchema.BlocklistEntryListResponse
  alias AtomicFi.OpenApiSchema.BlocklistEntryRequest
  alias AtomicFi.OpenApiSchema.BlocklistEntryResponse
