defmodule AtomicFiApi.ApiKeyController do
  use AtomicFiApi.Controller
  use OpenApiSpex.ControllerSpecs

  alias AtomicFi.ApiKeyContext
  alias AtomicFi.OpenApiSchema
  alias AtomicFi.OpenApiSchema.ApiKeyListResponse
  alias AtomicFi.OpenApiSchema.ApiKeyRequest
  alias AtomicFi.OpenApiSchema.ApiKeyResponse
