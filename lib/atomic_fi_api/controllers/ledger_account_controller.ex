defmodule AtomicFiApi.LedgerAccountController do
  use AtomicFiApi.Controller
  use OpenApiSpex.ControllerSpecs

  alias AtomicFi.LedgerAccountContext
  alias AtomicFi.OpenApiSchema
  alias AtomicFi.OpenApiSchema.LedgerAccountListResponse
  alias AtomicFi.OpenApiSchema.LedgerAccountRequest
  alias AtomicFi.OpenApiSchema.LedgerAccountResponse
