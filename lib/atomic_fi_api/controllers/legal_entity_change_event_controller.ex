defmodule AtomicFiApi.LegalEntityChangeEventController do
  use AtomicFiApi.Controller
  use OpenApiSpex.ControllerSpecs

  alias AtomicFi.LegalEntityChangeEventContext
  alias AtomicFi.OpenApiSchema
  alias AtomicFi.OpenApiSchema.LegalEntityChangeEventListResponse
  alias AtomicFi.OpenApiSchema.LegalEntityChangeEventRequest
  alias AtomicFi.OpenApiSchema.LegalEntityChangeEventResponse
