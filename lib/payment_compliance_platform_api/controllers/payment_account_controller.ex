defmodule PaymentCompliancePlatformApi.PaymentAccountController do
  use PaymentCompliancePlatformApi.Controller
  use OpenApiSpex.ControllerSpecs

  alias PaymentCompliancePlatform.OpenApiSchema
  alias PaymentCompliancePlatform.OpenApiSchema.PaymentAccountListResponse
  alias PaymentCompliancePlatform.OpenApiSchema.PaymentAccountRequest
  alias PaymentCompliancePlatform.OpenApiSchema.PaymentAccountResponse
  alias PaymentCompliancePlatform.PaymentAccountContext
