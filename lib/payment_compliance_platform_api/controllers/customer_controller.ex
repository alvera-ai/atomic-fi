defmodule PaymentCompliancePlatformApi.CustomerController do
  use PaymentCompliancePlatformApi.Controller
  use OpenApiSpex.ControllerSpecs

  alias PaymentCompliancePlatform.CustomerContext
  alias PaymentCompliancePlatform.OpenApiSchema
  alias PaymentCompliancePlatform.OpenApiSchema.CustomerListResponse
  alias PaymentCompliancePlatform.OpenApiSchema.CustomerRequest
  alias PaymentCompliancePlatform.OpenApiSchema.CustomerResponse
