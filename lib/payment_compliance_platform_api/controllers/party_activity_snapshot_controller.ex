defmodule PaymentCompliancePlatformApi.PartyActivitySnapshotController do
  use PaymentCompliancePlatformApi.Controller
  use OpenApiSpex.ControllerSpecs

  alias PaymentCompliancePlatform.OpenApiSchema
  alias PaymentCompliancePlatform.OpenApiSchema.PartyActivitySnapshotListResponse
  alias PaymentCompliancePlatform.OpenApiSchema.PartyActivitySnapshotRequest
  alias PaymentCompliancePlatform.OpenApiSchema.PartyActivitySnapshotResponse
  alias PaymentCompliancePlatform.PartyActivitySnapshotContext
