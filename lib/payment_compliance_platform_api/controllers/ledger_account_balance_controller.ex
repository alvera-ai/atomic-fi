defmodule PaymentCompliancePlatformApi.LedgerAccountBalanceController do
  use PaymentCompliancePlatformApi.Controller
  use OpenApiSpex.ControllerSpecs

  alias PaymentCompliancePlatform.LedgerAccountBalanceContext
  alias PaymentCompliancePlatform.OpenApiSchema.LedgerAccountBalanceListResponse
  alias PaymentCompliancePlatform.OpenApiSchema.LedgerAccountBalanceResponse
