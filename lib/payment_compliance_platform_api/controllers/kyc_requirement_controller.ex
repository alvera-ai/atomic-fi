defmodule PaymentCompliancePlatformApi.KycRequirementController do
  ...
  alias PaymentCompliancePlatform.OpenApiSchema.KycRequirementListResponse
  alias PaymentCompliancePlatform.OpenApiSchema.KycRequirementRequest
  alias PaymentCompliancePlatform.OpenApiSchema.KycRequirementResponse
