defmodule PaymentCompliancePlatformApi.SessionController do
  @moduledoc """
  ...
  * `DELETE /api/sessions` — authenticated (Bearer only). Revokes the
  ...
  alias PaymentCompliancePlatform.OpenApiSchema.SessionRequest
  alias PaymentCompliancePlatform.OpenApiSchema.SessionResponse
  alias PaymentCompliancePlatform.SessionContext
  alias PaymentCompliancePlatform.SessionContext.Session, as: SessionRecord
