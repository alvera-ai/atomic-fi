defmodule PaymentCompliancePlatformApi.RiskClassificationController do
  use PaymentCompliancePlatformApi.Controller
  use OpenApiSpex.ControllerSpecs

  alias PaymentCompliancePlatform.OpenApiSchema
  alias PaymentCompliancePlatform.OpenApiSchema.RiskClassificationListResponse
  alias PaymentCompliancePlatform.OpenApiSchema.RiskClassificationRequest
  alias PaymentCompliancePlatform.OpenApiSchema.RiskClassificationResponse
