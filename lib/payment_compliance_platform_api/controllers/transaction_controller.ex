defmodule PaymentCompliancePlatformApi.TransactionController do
  use PaymentCompliancePlatformApi.Controller
  use OpenApiSpex.ControllerSpecs

  alias PaymentCompliancePlatform.OpenApiSchema
  alias PaymentCompliancePlatform.OpenApiSchema.TransactionListResponse
  alias PaymentCompliancePlatform.OpenApiSchema.TransactionRequest
  alias PaymentCompliancePlatform.OpenApiSchema.TransactionResponse
