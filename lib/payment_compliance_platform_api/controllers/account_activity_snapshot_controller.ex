defmodule PaymentCompliancePlatformApi.AccountActivitySnapshotController do
  ...
  alias PaymentCompliancePlatform.OpenApiSchema.AccountActivitySnapshotListResponse
  alias PaymentCompliancePlatform.OpenApiSchema.AccountActivitySnapshotRequest
  alias PaymentCompliancePlatform.OpenApiSchema.AccountActivitySnapshotResponse
