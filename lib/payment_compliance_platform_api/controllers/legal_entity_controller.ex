defmodule PaymentCompliancePlatformApi.LegalEntityController do
  ...
  alias PaymentCompliancePlatform.OpenApiSchema.LegalEntityListResponse
  alias PaymentCompliancePlatform.OpenApiSchema.LegalEntityRequest
  alias PaymentCompliancePlatform.OpenApiSchema.LegalEntityResponse
