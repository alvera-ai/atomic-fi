defmodule PaymentCompliancePlatformApi.LedgerController do
  ...
  alias PaymentCompliancePlatform.OpenApiSchema.LedgerListResponse
  alias PaymentCompliancePlatform.OpenApiSchema.LedgerRequest
  alias PaymentCompliancePlatform.OpenApiSchema.LedgerResponse
