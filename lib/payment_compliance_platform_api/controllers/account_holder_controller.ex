defmodule PaymentCompliancePlatformApi.AccountHolderController do
  ...
  alias PaymentCompliancePlatform.OpenApiSchema.AccountHolderListResponse
  alias PaymentCompliancePlatform.OpenApiSchema.AccountHolderRequest
  alias PaymentCompliancePlatform.OpenApiSchema.AccountHolderResponse
