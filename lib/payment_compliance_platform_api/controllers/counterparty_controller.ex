defmodule PaymentCompliancePlatformApi.CounterpartyController do
  ...
  alias PaymentCompliancePlatform.OpenApiSchema.CounterpartyListResponse
  alias PaymentCompliancePlatform.OpenApiSchema.CounterpartyRequest
  alias PaymentCompliancePlatform.OpenApiSchema.CounterpartyResponse
