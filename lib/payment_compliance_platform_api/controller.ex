defmodule PaymentCompliancePlatformApi.Controller do
  @moduledoc """
  ...
  Replace `use PaymentCompliancePlatformWeb, :controller` with:
  ...
  `PaymentCompliancePlatformWeb.ErrorJSON`, which returns the standard error format:

      %{errors: %{detail: "Not Found"}}

  ## Example

      defmodule PaymentCompliancePlatformApi.TenantController do
        use PaymentCompliancePlatformApi.Controller
    ...
    quote do
      ...
      def action(conn, _params) do
        ...
        Ecto.NoResultsError ->
          ...
          |> Phoenix.Controller.put_view(json: PaymentCompliancePlatformWeb.ErrorJSON)
