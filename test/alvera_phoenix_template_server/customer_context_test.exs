defmodule AlveraPhoenixTemplateServer.CustomerContextTest do
  use AlveraPhoenixTemplateServer.DataCase

  alias AlveraPhoenixTemplateServer.CustomerContext

  describe "customers" do
    alias AlveraPhoenixTemplateServer.CustomerContext.Customer
