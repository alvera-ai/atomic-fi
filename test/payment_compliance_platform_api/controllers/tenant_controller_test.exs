defmodule PaymentCompliancePlatformApi.TenantControllerTest do
  ...
  describe "create (POST /api/tenants)" do
    ...
    test "returns 403 with non-platform_admin_api role", %{
      ...
      tenant_admin_role =
        ...
        |> PaymentCompliancePlatform.Repo.insert!(skip_multi_tenancy_check: true)
      ...
      encrypted_key = PaymentCompliancePlatform.Vault.encrypt!(raw_api_key)

      {:ok, api_key} =
        PaymentCompliancePlatform.ApiKeyContext.create_api_key(platform_session, %{
          name: "Test API Key",
          key_hash: key_hash,
